...
# directory.
#
410TESTS = ck1 merchant peon knife fork_test1 exec_basic_helper exec_basic exec_nonexist coolness new_pages mem_permissions print_basic readline_basic deschedule_hang
...
# directory.
#
STUDENTTESTS =  introspective schizo introvert garrulous mimic zfod cooperative annoying vanish_test
...
#
KERNEL_OBJS = kernel.o lib/atomic.o lib/spin.o lib/cvar.o lib/mutex.o entry/syscall/finish_fork.o lib/cllist.o sched/ctx_switch_wrappers.o sched/sched.o sched/ctx_switch.o lib/malloc_wrappers.o vm/vm.o vm/asm_tlb.o vm/tlb.o vm/page_alloc.o vm/frame_alloc.o vm/pg_table.o mode_switch.o loader/loader.o loader/usr_stack.o entry/drivers/keyboard.o entry/drivers/timer.o entry/idt.o entry/drivers/driver_wrappers.o entry/drivers/console.o entry/drivers/cursor.o entry/syscall/sc_utils.o entry/syscall/syscall_wrappers.o entry/syscall/syscalls.o entry/faults/faults.o entry/faults/fault_wrappers.o entry/drivers/drivers.o sched/thread.o
