...
#
KERNEL_OBJS = kernel.o vm/copy_vm.o entry/syscall/finish_fork.o entry/syscall/fork_i.o lib/cllist.o sched/ctx_switch.o sched/asm_ctx_switch.o lib/malloc_wrappers.o vm/vm.o vm/paging.o vm/page_alloc.o vm/frame_alloc.o vm/pg_table.o mode_switch.o loader/loader.o loader/usr_stack.o entry/drivers/keyboard.o entry/drivers/timer.o entry/idt.o entry/drivers/driver_wrappers.o entry/drivers/fake_console.o entry/syscall/sc_utils.o entry/syscall/syscall_wrappers.o entry/syscall/syscalls.o entry/faults/faults.o entry/faults/fault_wrappers.o entry/drivers/drivers.o sched/thread.o
###########################################################################
