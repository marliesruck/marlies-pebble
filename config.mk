...
# directory.
#
410TESTS = ck1 merchant peon knife fork_test1 exec_basic_helper exec_basic exec_nonexist coolness new_pages remove_pages_test1 remove_pages_test2 mem_permissions print_basic readline_basic deschedule_hang loader_test1 loader_test2 fork_wait getpid_test1 wait_getpid stack_test1 sleep_test1 minclone_mem
...
# directory.
#
STUDENTTESTS =  introspective schizo introvert garrulous mimic zfod cooperative annoying coquettish coy cooperative_terminate merchant_terminate peon_terminate coolness_terminate coy_terminate regression epileptic rogue intrepid
...
#
KERNEL_OBJS = kernel.o lib/page_util.o lib/atomic.o lib/spin.o lib/cvar.o lib/mutex.o lib/cllist.o sched/process.o sched/dispatch_wrapper.o sched/sched.o sched/dispatch.o lib/malloc_wrappers.o vm/vm.o vm/asm_tlb.o vm/tlb.o vm/page_alloc.o vm/frame_alloc.o vm/pg_table.o loader/loader.o loader/usr_stack.o entry/drivers/keyboard.o entry/drivers/timer.o entry/idt.o entry/drivers/driver_wrappers.o entry/drivers/console.o entry/drivers/cursor.o entry/syscall/lifecycle.o entry/syscall/swexn.o entry/syscall/threadmgmt.o entry/syscall/mem_mgmt.o entry/syscall/misc_syscalls.o entry/syscall/console_io.o entry/syscall/finish_fork.o entry/syscall/sc_utils.o entry/syscall/syscall_wrappers.o entry/faults/faults.o entry/faults/fault_wrappers.o entry/drivers/drivers.o sched/thread.o 
